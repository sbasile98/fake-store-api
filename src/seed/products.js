const products = [
  ...
  { title: 'Cuffie Bluetooth Wireless', description: 'Cuffie over-ear wireless premium con cancellazione attiva del rumore, 30 ore di autonomia e supporto audio Hi-Res. Cuscinetti in memory foam per un comfort prolungato.', price: 149.99, sku: 'ELET-1001', categoryId: 1, brand: 'SoundMax', rating: 4.5, ratingCount: 342 },
  { title: 'Smart TV 4K Ultra HD 55"', description: 'Display 4K cristallino con supporto HDR10+, app di streaming integrate, controllo vocale e audio Dolby Atmos. Perfetta per serate cinema e gaming.', price: 699.99, sku: 'ELET-1002', categoryId: 1, brand: 'VisionPro', rating: 4.7, ratingCount: 218 },
  ...
  { title: 'Smartphone X12', description: 'Smartphone di punta con display AMOLED da 6.7 pollici, tripla fotocamera (108MP + 12MP + 5MP), connettivita\' 5G e batteria che dura tutto il giorno.', price: 899.99, sku: 'ELET-1004', categoryId: 1, brand: 'PhoneX', rating: 4.4, ratingCount: 489 },
  ...
  { title: 'Tastiera Meccanica Gaming', description: 'Tastiera meccanica RGB con switch Cherry MX, tasti macro programmabili, telaio in alluminio e poggiapolsi rimovibile. N-key rollover per il gaming competitivo.', price: 129.99, sku: 'ELET-1006', categoryId: 1, brand: 'GameGear', rating: 4.6, ratingCount: 283 },
  ...
  { title: 'Cassa Bluetooth Portatile', description: 'Cassa portatile impermeabile con suono a 360 gradi, 20 ore di autonomia, microfono integrato per chiamate e modalita\' luci RGB.', price: 79.99, sku: 'ELET-1008', categoryId: 1, brand: 'SoundMax', rating: 4.4, ratingCount: 321 },
  ...
  { title: 'Tablet Air 10"', description: 'Tablet da 10.9 pollici con display Retina, processore octa-core, 128GB di memoria, supporto per pennino e batteria che dura tutto il giorno.', price: 449.99, sku: 'ELET-1010', categoryId: 1, brand: 'TechBook', rating: 4.5, ratingCount: 178 },
  ...
  { title: 'Jeans Slim Fit', description: 'Jeans slim fit moderni in denim elasticizzato premium. Vita media comoda, gamba affusolata e classico design a cinque tasche.', price: 59.99, sku: 'ABBI-2002', categoryId: 2, brand: 'DenimCo', rating: 4.4, ratingCount: 634 },
  ...
  { title: 'Scarpe da Running Pro', description: 'Scarpe da corsa leggere con ammortizzazione reattiva, tomaia in mesh traspirante e suola in gomma resistente. Progettate per strada e sentieri.', price: 119.99, sku: 'ABBI-2004', categoryId: 2, brand: 'SpeedStep', rating: 4.5, ratingCount: 478 },
  ...
  { title: 'Occhiali da Sole Aviator', description: 'Occhiali da sole aviator classici con lenti polarizzate, protezione UV400 e montatura leggera in metallo. Include custodia e panno per pulizia.', price: 69.99, sku: 'ABBI-2006', categoryId: 2, brand: 'SunStyle', rating: 4.2, ratingCount: 567 },
  ...
  { title: 'Scarponi da Trekking Impermeabili', description: 'Scarponi da trekking robusti e impermeabili con suola Vibram, fodera Gore-Tex e supporto alla caviglia. Per avventure serie su qualsiasi terreno.', price: 179.99, sku: 'ABBI-2008', categoryId: 2, brand: 'TrailMaster', rating: 4.6, ratingCount: 312 },
  ...
  { title: 'Manuale di Data Science', description: 'Dalle basi della statistica alle applicazioni di machine learning. Include progetti pratici con Python, dataset reali ed esercizi concreti.', price: 49.99, sku: 'LIBR-3002', categoryId: 3, brand: 'TechPress', rating: 4.6, ratingCount: 312 },
  ...
  { title: 'La Mente Creativa', description: 'Esplora la scienza della creativita\' e dell\'innovazione. Combina ricerche neuroscientifiche con tecniche pratiche per sbloccare il tuo potenziale creativo.', price: 19.99, sku: 'LIBR-3005', categoryId: 3, brand: 'MindBooks', rating: 4.3, ratingCount: 423 },
  ...
  { title: 'Cucina per Tutti', description: 'Oltre 200 ricette facili da seguire per ogni livello. Copre cucine internazionali, meal prep, restrizioni alimentari e basi di cucina.', price: 29.99, sku: 'LIBR-3007', categoryId: 3, brand: 'FoodBooks', rating: 4.6, ratingCount: 567 },
  ...
  { title: 'Set Pentole in Acciaio Inox', description: 'Set professionale da 10 pezzi con costruzione tri-ply in acciaio inox, manici rivettati e coperchi in vetro temperato. Adatto al forno fino a 260°C.', price: 199.99, sku: 'CASA-4001', categoryId: 4, brand: 'ChefLine', rating: 4.7, ratingCount: 289 },
  ...
  { title: 'Cuscino in Memory Foam', description: 'Cuscino ergonomico sagomato con memory foam arricchito di gel rinfrescante. Supporta collo e colonna vertebrale. Include fodera ipoallergenica in bambu\'.', price: 49.99, sku: 'CASA-4003', categoryId: 4, brand: 'SleepWell', rating: 4.4, ratingCount: 678 },
  ...
  { title: 'Purificatore d\'Aria HEPA', description: 'Purificatore d\'aria True HEPA che copre fino a 40 mq. Cattura il 99,97% di allergeni, polvere e fumo. Modalita\' notte silenziosa e indicatore qualita\' dell\'aria.', price: 159.99, sku: 'CASA-4006', categoryId: 4, brand: 'PureAir', rating: 4.5, ratingCount: 267 },
  ...
  { title: 'Termostato Smart', description: 'Termostato smart WiFi con capacita\' di apprendimento, report energetici e integrazione con assistenti vocali. Risparmia fino al 23% su riscaldamento e raffrescamento.', price: 199.99, sku: 'CASA-4008', categoryId: 4, brand: 'SmartHome', rating: 4.6, ratingCount: 189 },
  ...
  { title: 'Set Manubri Regolabili', description: 'Manubri regolabili salvaspazio da 2,5 kg a 25 kg ciascuno. Sistema di cambio peso rapido con meccanismo di blocco sicuro. Include vassoio portaoggetti.', price: 299.99, sku: 'SPRT-5002', categoryId: 5, brand: 'IronPower', rating: 4.7, ratingCount: 234 },
  ...
  { title: 'Borraccia Termica', description: 'Borraccia in acciaio inox a doppia parete con isolamento sottovuoto. Mantiene le bevande fredde 24h o calde 12h. Capacita\' 750ml con tappo a prova di perdita. Senza BPA.', price: 24.99, sku: 'SPRT-5004', categoryId: 5, brand: 'HydroMax', rating: 4.6, ratingCount: 789 },
  ...
  { title: 'Set Elastici Fitness', description: 'Set di 5 elastici di resistenza con diversi livelli di tensione (2-23 kg). Include ancoraggio per porta, maniglie, cavigliere e guida agli esercizi.', price: 19.99, sku: 'SPRT-5006', categoryId: 5, brand: 'FlexBand', rating: 4.3, ratingCount: 678 },
  ...
  { title: 'Orologio Fitness Tracker', description: 'Fitness tracker avanzato con cardiofrequenzimetro, GPS, monitoraggio del sonno, sensore ossigeno nel sangue e 7 giorni di autonomia. Impermeabile fino a 50m.', price: 129.99, sku: 'SPRT-5008', categoryId: 5, brand: 'FitPulse', rating: 4.4, ratingCount: 456 },
  ...
  { title: 'Spazzolino Elettrico Pro', description: 'Spazzolino elettrico sonico con 5 modalita\' di pulizia, sensore di pressione, timer 2 minuti e 30 giorni di autonomia. Include 3 testine e custodia da viaggio.', price: 79.99, sku: 'BELL-6002', categoryId: 6, brand: 'DentaCare', rating: 4.6, ratingCount: 423 },
  ...
  { title: 'Crema Viso Idratante', description: 'Crema idratante quotidiana ricca con ceramidi, niacinamide e SPF 30. Formula non grassa adatta a tutti i tipi di pelle. Testata dermatologicamente. 50ml.', price: 24.99, sku: 'BELL-6004', categoryId: 6, brand: 'GlowSkin', rating: 4.5, ratingCount: 678 },
  ...
  { title: 'Set Oli Essenziali', description: 'Set di 8 oli essenziali puri: lavanda, eucalipto, tea tree, menta, arancia, limone, rosmarino e incenso. 10ml ciascuno. Per diffusore o uso topico.', price: 24.99, sku: 'BELL-6007', categoryId: 6, brand: 'PureEssence', rating: 4.6, ratingCount: 456 },
